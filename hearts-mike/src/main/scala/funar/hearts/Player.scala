...
object Player {
  ...
  def chooserStrategy[PlayerId, Effects](chooser: Chooser[PlayerId, Effects])
          (implicit member: State[PlayerState[PlayerId], *] |= Effects): Strategy[Effects] = {
  ...
  def alongStrategy[PlayerId, Effects](implicit member: State[PlayerState[PlayerId], *] |= Effects): Strategy[Effects] =
  ...
  def interactiveStrategy[PlayerId, Effects]
    (implicit ttyState: Teletype |= Effects,
              memberState: State[PlayerState[PlayerId], *] |= Effects): Strategy[Effects] =
